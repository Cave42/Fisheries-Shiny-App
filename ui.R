...
fluidPage(
  ...
  titlePanel("Comparing Stock Status in Two Dimensions"),

  navbarPage(
    "Stock Staus Quadplot-- measuring overfished and overfishing conditions across stocks and time in four quadrants"
  ),
  ...
  h5(
    "The four quadrants are based on reference points for each axis."
  ),
  ...
  tabsetPanel(
    ...
    tabPanel(
        ...
        column(
          ...
          dropdown(
            radioGroupButtons(
              ...
              choices = c("Latest", "First & Last", "Custom", "All"),
      ...
      column(
        ...
        conditionalPanel(
          condition = "input.customFile1 == false",
          h5("Use Default File"),
        ),

        conditionalPanel(
          condition = "input.customFile1 == true",
          h5("Use Custom File"),
        ),
    ...
    tabPanel(
      "Animation",
      div(
        plotlyOutput(outputId = "distPlot2", height = "100%"),
        align = "center"
      ) %>%
      ...
      column(
        ...
        conditionalPanel(
          condition = "input.customFile2 == false",
          h5("Use Default File"),
        ),

        conditionalPanel(
          condition = "input.customFile2 == true",
          h5("Use Custom File"),
        ),
